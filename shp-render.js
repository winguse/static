...
If your credential is leaked, you must go to your <a href="https://myaccount.google.com/permissions">Google Account</a> to revoke the application access to <code>go-shp</code> in <code>Signing in with Google</code> immediately. Or, your credential(s) will never expire.
...
new QRCode(document.getElementById("qrcode-${s}"), {
  text: "https://${btoa(`${email}:SR:${refreshToken}@${s}:443`)}?cert=&peer=",
  width: 256,
  height: 256,
  colorDark : "#000000",
  colorLight : "#ffffff",
